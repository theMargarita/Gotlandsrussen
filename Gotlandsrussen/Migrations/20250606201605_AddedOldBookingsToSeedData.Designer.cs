...
namespace GotlandsrussenAPI.Migrations
{
    ...
    [Migration("20250606201605_AddedOldBookingsToSeedData")]
    partial class AddedOldBookingsToSeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gotlandsrussen.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            NumberOfAdults = 2,
                            NumberOfChildren = 1,
                            ToDate = new DateOnly(2025, 5, 17)
                        },
                        new
                        {
                            Id = 22,
                            Breakfast = false,
                            FromDate = new DateOnly(2025, 4, 20),
                            GuestId = 2,
                            IsCancelled = false,
                            NumberOfAdults = 1,
                            NumberOfChildren = 2,
                            ToDate = new DateOnly(2025, 4, 22)
                        },
                        new
                        {
                            Id = 23,
                            Breakfast = true,
                            FromDate = new DateOnly(2025, 1, 5),
                            GuestId = 3,
                            IsCancelled = false,
                            NumberOfAdults = 1,
                            NumberOfChildren = 0,
                            ToDate = new DateOnly(2025, 6, 6)
                        });
                });
